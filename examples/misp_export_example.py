...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Export SpiderFoot scan to MISP format")
    ...
    parser.add_argument(
        "-t", "--tag", help="TLP tag (default: tlp:amber)", default="tlp:amber")
...
def main():
    ...
    print(
        f"Event contains {len(event.attributes)} attributes and {len(event.objects)} objects")
