...
def parse_args() -> Tuple[argparse.Namespace, Dict[str, Any]]:
    ...
    server_group.add_argument("-p", "--port", type=int,
                              default=5001, help="Listen port (default: 5001)")
    server_group.add_argument(
        "-l", "--listen", default="127.0.0.1", help="Listen IP (default: 127.0.0.1)")
    server_group.add_argument(
        "-r", "--root", default="/", help="Root path for the application")
    ...
    security_group.add_argument(
        "-k", "--api-key-auth", action="store_true", help="Enable API key authentication")
    security_group.add_argument(
        "--api-key", help="Specify API key (default: auto-generated)")
    security_group.add_argument(
        "--show-api-key", action="store_true", help="Show API key on startup")
    security_group.add_argument(
