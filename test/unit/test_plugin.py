...
class TestSpiderFootPlugin(unittest.TestCase):
    ...
    def test_check_for_stop(self):
        ...
        self.plugin.__scanId__ = "SCAN123"
        self.plugin.__sfdb__ = mock.MagicMock(
            scanInstanceGet=mock.MagicMock(return_value=None)
        )
    ...
    def test_notify_listeners(self, mock_event):
        ...
        listener1 = mock.MagicMock(
            watchedEvents=mock.MagicMock(return_value=["TEST"]))
        listener2 = mock.MagicMock(
            watchedEvents=mock.MagicMock(return_value=["OTHER"]))
    ...
    def test_as_dict(self):
        ...
        self.assertEqual(result["optdescs"], {
