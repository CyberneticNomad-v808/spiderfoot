...
class TestSpiderFootHelpers(unittest.TestCase):
    ...
    def test_data_path(self, mock_makedirs, mock_isdir, mock_getenv):
        ...
        self.assertEqual(SpiderFootHelpers.dataPath(),
                         f"{home_dir}/.spiderfoot")
    ...
    def test_log_path(self, mock_makedirs, mock_isdir, mock_getenv):
        ...
        mock_isdir.return_value = True
        home_dir = str(Path.home())
        self.assertEqual(SpiderFootHelpers.logPath(),
                         f"{home_dir}/.spiderfoot/logs")
    ...
    def test_target_type_from_string(self):
        ...
        self.assertEqual(
            SpiderFootHelpers.targetTypeFromString("192.168.1.1"), "IP_ADDRESS"
        )
        self.assertEqual(
            SpiderFootHelpers.targetTypeFromString(
        ...
        self.assertEqual(
            SpiderFootHelpers.targetTypeFromString("AS12345"), "BGP_AS_OWNER"
        )
        self.assertEqual(
            SpiderFootHelpers.targetTypeFromString(
    ...
    def test_url_relative_to_absolute(self):
        ...
        self.assertEqual(
            SpiderFootHelpers.urlRelativeToAbsolute(
        ...
        self.assertEqual(
            SpiderFootHelpers.urlRelativeToAbsolute(base_url, absolute_url),
            absolute_url,
        )

        # Test invalid inputs
        self.assertIsNone(
            SpiderFootHelpers.urlRelativeToAbsolute(None, "path"))
        ...
        self.assertIsNone(
            SpiderFootHelpers.urlRelativeToAbsolute("https://example.com", "")
        )
    ...
    def test_url_base_dir(self):
        ...
        self.assertEqual(
            SpiderFootHelpers.urlBaseDir(url), "https://example.com/path/to/"
        )
        ...
        self.assertEqual(SpiderFootHelpers.urlBaseDir(url),
                         "https://example.com/")
    ...
    def test_url_base_url(self):
        ...
        # Test with file URL
        url = "https://example.com/path/to/file.html"
        self.assertEqual(SpiderFootHelpers.urlBaseUrl(url),
                         "https://example.com")
    ...
    def test_valid_email(self):
        ...
        self.assertTrue(SpiderFootHelpers.validEmail(
    ...
    def test_country_name_from_country_code(self):
        ...
        self.assertEqual(
            SpiderFootHelpers.countryNameFromCountryCode(
                "GB"), "United Kingdom"
        )
