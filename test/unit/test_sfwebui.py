...
class TestSpiderFootWebUi(unittest.TestCase):
    ...
    def test_startscan(self, mock_request):
        ...
        with mock.patch.object(self.webui, 'getform', return_value=mock_form_data):
            with mock.patch.object(self.webui, 'cleanUserInput', return_value='cleaned'):
                with mock.patch('sflib.SpiderFoot.genScanInstanceId', return_value='abc123'):
    ...
    def test_stopscanrun(self):
        ...
        with mock.patch.object(self.webui.sfdb, 'scanInstanceGet', return_value=['', '', '', '', '', 'RUNNING']):
            with mock.patch.object(self.webui.sfdb, 'scanInstanceSet') as mock_set:
                with mock.patch('cherrypy.HTTPRedirect') as mock_redirect:
                    self.webui.stopscanrun('abc123')
                    
                    # Check if scan was stopped
                    mock_set.assert_called_once_with('abc123', status='ABORT-REQUESTED')
    ...
    def test_stopscanrun_not_running(self):
        ...
        with mock.patch.object(self.webui.sfdb, 'scanInstanceGet', return_value=['', '', '', '', '', 'FINISHED']):
            with mock.patch('cherrypy.HTTPRedirect') as mock_redirect:
                self.webui.stopscanrun('abc123')
                
                # Check if redirect happened without changing status
                mock_redirect.assert_called_once()
    ...
    def test_scanviz(self):
        ...
        with mock.patch.object(self.webui, 'render_template') as mock_render:
            with mock.patch.object(self.webui.sfdb, 'scanInstanceGet', return_value=['Test Scan', 'example.com', 0, 0, 0, 'FINISHED']):
    ...
    def test_scanopts(self):
        ...
        with mock.patch.object(self.webui.sfdb, 'scanInstanceGet', return_value=['Test Scan', 'example.com', 0, 0, 0, 'FINISHED']):
            ...
            with mock.patch.object(self.webui.sfdb, 'scanConfigGet', return_value={'module.enabled': '1'}):
    ...
    def test_rerunscan(self):
        ...
        with mock.patch.object(self.webui.sfdb, 'scanInstanceGet', return_value=scan_data):
            with mock.patch.object(self.webui.sfdb, 'scanConfigGet', return_value=scan_config):
                with mock.patch('sflib.SpiderFoot.genScanInstanceId', return_value='new_scan_id'):
                    with mock.patch('sfscan.startSpiderFootScanner') as mock_start_scan:
                        with mock.patch('cherrypy.HTTPRedirect') as mock_redirect:
    ...
    def test_resultexport(self):
        ...
        with mock.patch.object(self.webui.sfdb, 'scanInstanceGet', return_value=scan_data):
            with mock.patch.object(self.webui, 'cleanUserInput', return_value='gexf'):
                with mock.patch.object(self.webui, 'exportResultsGEXF') as mock_export_gexf:
                    ...
                    mock_export_gexf.assert_called_once_with('abc123', 'example.com')
    ...
    def test_resultexport_json(self):
        ...
        with mock.patch.object(self.webui.sfdb, 'scanInstanceGet', return_value=scan_data):
            with mock.patch.object(self.webui, 'cleanUserInput', return_value='json'):
                with mock.patch.object(self.webui, 'exportResultsJSON') as mock_export_json:
                    # Set up mock response
                    ...
                    # Verify export was called
                    mock_export_json.assert_called_once_with('abc123', 'example.com')
    ...
    def test_eventresults(self):
        ...
        with mock.patch.object(self.webui, 'cleanUserInput', return_value='IP_ADDRESS'):
            with mock.patch.object(self.webui.sfdb, 'scanInstanceGet', return_value=['Test Scan', 'example.com', 0, 0, 0, 'FINISHED']):
                with mock.patch.object(self.webui.sfdb, 'scanResultEvent') as mock_result:
                    # Set up mock response
                    mock_result.return_value = [
                        [1, "192.168.0.1", "example.com", "sfp_dns", "IP_ADDRESS", 
                        100, 100, 1, "hash1", "source_hash", "module1", 12345]
                    ]
                    ...
                    with mock.patch.object(self.webui, 'jsonify') as mock_jsonify:
                        ...
                        mock_result.assert_called_once_with('abc123', eventType='IP_ADDRESS')
                        mock_jsonify.assert_called_once()
    
    def test_scansummary(self):
        """Test getting scan summary."""
        with mock.patch.object(self.webui.sfdb, 'scanInstanceGet', return_value=['Test Scan', 'example.com', 0, 0, 0, 'FINISHED']):
            with mock.patch.object(self.webui.sfdb, 'scanResultSummary') as mock_summary:
                # Set up mock response
    ...
    def test_jsonify(self):
        ...
        try:
            ...
            sys.modules['cherrypy'].response.headers['Content-Type'] = 'application/json'
