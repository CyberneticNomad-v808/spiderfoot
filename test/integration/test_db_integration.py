...
class TestSpiderFootDbIntegration(unittest.TestCase):
    ...
    def test_full_scan_workflow(self):
        ...
        child_event = SpiderFootEvent("DOMAIN_NAME", "subdomain.example.com", "test_module", root_event)
        self.db.scanEventStore(scan_id, child_event)
        
        ip_event = SpiderFootEvent("IP_ADDRESS", "192.168.1.1", "test_module", child_event)
        ...
        src_events = self.db.scanResultEventUnique(scan_id, eventHash=src_event_hash)
        ...
        search_results = self.db.search({'scan_id': scan_id, 'type': 'IP_ADDRESS', 'value': '192.168.1.1'})
