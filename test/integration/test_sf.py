...
class TestSf(TestModuleBase):
    ...
    def setUp(self: 'TestSf') -> None:
        """Enhanced setUp with ThreadReaper module tracking."""
        super().setUp()
        # ThreadReaper infrastructure is automatically initialized

    def tearDown(self: 'TestSf') -> None:
    ...
    def test_no_args_should_print_arg_l_required(self: 'TestSf') -> None:
        """Test that no args prints usage."""
    ...
    def test_help_arg_should_print_help_and_exit(self: 'TestSf') -> None:
        """Test that -h prints help and exits."""
    ...
    def test_modules_arg_should_print_modules_and_exit(self: 'TestSf') -> None:
        """Test that -M prints modules and exits."""
    ...
    def test_types_arg_should_print_types_and_exit(self: 'TestSf') -> None:
        """Test that -T prints types and exits."""
    ...
    @pytest.mark.skip(reason='Requires integration DB with write permissions to schema public')
    def test_l_arg_should_start_web_server(self: 'TestSf') -> None:
        """Test that -l starts web server."""
    ...
    @pytest.mark.skip(reason='Requires integration DB with write permissions to schema public')
    def test_debug_arg_should_enable_and_print_debug_output(self: 'TestSf') -> None:
        """Test that -d enables debug output."""
        ...
        self.assertTrue(has_debug_output,
                        'No debug output found. stdout: ' + str(out[:300]) + ', stderr: ' + str(err[:300]))
    ...
    def test_quiet_arg_should_hide_debug_output(self: 'TestSf') -> None:
        """Test that -q hides debug output."""
        with patch('spiderfoot.core.modules.ModuleManager.load_modules', return_value={'sfp__stor_stdout': {'opts': {}}}), \
             patch('spiderfoot.SpiderFootHelpers.loadModulesAsDict', return_value={'sfp__stor_stdout': {'opts': {}}}):
            out, err, code = self.execute(
    ...
    def test_run_scan_invalid_target_should_exit(self: 'TestSf') -> None:
        """Test that invalid target causes exit."""
        invalid_target = '.'
        with patch('spiderfoot.core.modules.ModuleManager.load_modules', return_value={'sfp__stor_stdout': {'opts': {}}}), \
             patch('spiderfoot.SpiderFootHelpers.loadModulesAsDict', return_value={'sfp__stor_stdout': {'opts': {}}}):
            out, err, code = self.execute(
        ...
        self.assertTrue(has_error_output or has_error_exit,
                        'No error indication found for invalid target. stdout: ' + str(out[:300]) + ', stderr: ' + str(err[:300]) + ', code: ' + str(code))

        # Assert that exit code indicates error (not success)
        self.assertIn(code, (255, 4294967295, 1, -1, 2))

    @pytest.mark.skip(reason='Requires integration DB with write permissions to schema public')
    def test_run_scan_with_modules_no_target_should_exit(self: 'TestSf') -> None:
        """Test that modules without target causes exit."""
        with patch('spiderfoot.core.modules.ModuleManager.load_modules', return_value={'sfp__stor_stdout': {'opts': {}}}), \
             patch('spiderfoot.SpiderFootHelpers.loadModulesAsDict', return_value={'sfp__stor_stdout': {'opts': {}}}):
            out, err, code = self.execute(
        ...
        self.assertTrue(has_scan_output,
                        'No scan-related output found. stdout: ' + str(out[:300]) + ', stderr: ' + str(err[:300]))

        # Accept wider range of exit codes as behavior may vary across platforms
        self.assertIn(code, (0, 255, 4294967295, 1, -1, 2))

    @pytest.mark.skip(reason='Requires integration DB with write permissions to schema public')
    def test_run_scan_with_types_no_target_should_exit(self: 'TestSf') -> None:
        """Test that types without target causes exit."""
        with patch('spiderfoot.core.modules.ModuleManager.load_modules', return_value={'sfp__stor_stdout': {'opts': {}}}), \
             patch('spiderfoot.SpiderFootHelpers.loadModulesAsDict', return_value={'sfp__stor_stdout': {'opts': {}}}):
            out, err, code = self.execute(
    ...
    def test_run_scan_with_invalid_module_should_run_scan_and_exit(self: 'TestSf') -> None:
        """Test that invalid module still runs scan and exits."""
    ...
    def test_run_scan_with_invalid_type_should_exit(self: 'TestSf') -> None:
        """Test that invalid type causes exit."""
        with patch('spiderfoot.core.modules.ModuleManager.load_modules', return_value={'sfp__stor_stdout': {'opts': {}}}), \
             patch('spiderfoot.SpiderFootHelpers.loadModulesAsDict', return_value={'sfp__stor_stdout': {'opts': {}}}):
            out, err, code = self.execute(
    ...
    def test_run_scan_should_run_scan_and_exit(self: 'TestSf') -> None:
        """Test that scan runs and exits."""
    ...
    def test_run_scan_should_print_scan_result_and_exit(self: 'TestSf') -> None:
        """Test that scan prints result and exits."""
        target = 'van1shland.io'
